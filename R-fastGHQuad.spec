...
%prep
%setup -q -n fastGHQuad
pushd ..
cp -a fastGHQuad buildavx2
popd
pushd ..
cp -a fastGHQuad buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737140822
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/fastGHQuad/libs/fastGHQuad.so
/V4/usr/lib64/R/library/fastGHQuad/libs/fastGHQuad.so
